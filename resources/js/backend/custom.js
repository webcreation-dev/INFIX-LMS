...
$(function () {
    $(document).on('click', '.deleteOnlineExam', function (e) {
        var my_id_value = $(this).data('id');
        console.log(my_id_value);
...
$(function () {
    $(document).on('click', '.deleteOnlineExamQuestion', function (e) {
        var my_id_value = $(this).data('id');
...
$(function () {
    $(document).on('click', '.deleteAssignVehicle', function (e) {
        var my_id_value = $(this).data('id');
...
$(document).on("click", "#create-option", function (event) {
    ...
    for (var i = 1; i <= number_of_option; i++) {
        ...
        appendRow += "</div>";
        appendRow += "</div>";
        appendRow += "<div class='col-lg-2 mt-15 optionCorrect'>";
...
$(document).ready(function () {
    ...
    $(document).on('change', '#select_academic_year', function (e) {
        var url = $('#url').val();
        var formData = {
            year: $(this).val()
        };
