...
class InitRepository {
    ...
    public function init() {
        config(['app.verifier' => 'http://www.google.com']);
        config(['app.ux_verifier' => 'http://www.google.com']);
...
/*
        $url = verifyUrl(config('spondonit.verifier', 
        'auth')) . '/api/cc?a=verify&u=' . app_url() . '&ac=' . $ac . '&i=' . config('app.item') . '&e=' . $e . '&c=' . $c . '&v=' . $v.'&current='.urlencode(request()->path());
        $response = curlIt($url);
*/
