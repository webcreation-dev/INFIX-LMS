                ...
                <div class="col-md-12">
                    <form method="post" action="{{ route('service.license') }}" id="content_form">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control " name="access_code" id="access_code"   autofocus="" value="{{ old('access_code', request('access_code')) }}"  placeholder="{{ __('service::install.access_code') }}" >
                            @if(request('message'))
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" name="envato_email" id="envato_email" value="{{ old('envato_email', request('envato_email')) }}"  placeholder="{{ __('service::install.envato_email') }}" >
                        </div>

                        <div class="form-group">
                            <label class="required" for="installed_domain">{{ __('service::install.installed_domain') }}</label>
                            <input type="text" class="form-control" name="installed_domain" id="installed_domain"  readonly value="{{ app_url() }}" >
                        </div>
                        @if($reinstall)
                            <div class="form-group">
